...
function checkLogin() {
    ...
    xhttp.open("GET", "_@checklogin.php", true);
    xhttp.send();
}
...
menuItems.forEach(item => {
    item.addEventListener('click', function() {
        ...
        // Show home if home
        if (menuText === 'home') {
            if (window.location.href === "http://localhost/lifelink/index.php") {
                return;
            } else {
        ...
        donorCard.innerHTML = `
            ...
            <div class="donor-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">${donor.extraction_datetime == null ? formatDateTime(donor.extraction_datetime) : 'No Record'}</span>
                </div>
                <div class="detail-row">
            ...
            <div class="donor-footer">
                <span class="availability ${donor.available != '0' ? 'available' : 'unavailable'}">
                    ...
                    ${donor.available != '0' ? 'Available for donation' : `Next eligible: ${formatDate(donor.next_available)}`}
                </span>
                <a href="_request-donor.php?request=${donor.email}">
