...
<body>
                ...
                <div class="donation-form-container">
                    <section class="card donation-form-card">
                        ...
                        <div style="text-align: center; margin: 1rem;">
                            ...
                            if($status === 'pending') {
                                echo "<p class='urgent-tag' style='color: var(--primary-dark); font-weight: bold; text-align: center'>Ongoing Appointment Pending</p>";
    ...
    <ul class="request-list" style="max-height: 600px; overflow-y: auto;">
