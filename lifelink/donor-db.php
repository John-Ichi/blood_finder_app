...
$session_info = "SELECT * FROM donor_info WHERE email='$current_session'";
...
$session_rqs = "SELECT * FROM blood_requests WHERE requested_donor='$sess_id'"; // sql for getting donor's blood requests
...
if(isset($_POST['donation_appointment'])) {
...
<head>
    ...
    <link rel="stylesheet" href="donor-db.css">
    ...
    <div class="top-nav">
        <div class="top-nav-content">
            ...
            <div class="top-nav-links">
                ...
                <a href="donors.php">Donor Lists</a>
            ...
            <div class="dashboard">
                ...
                <section class="card">
                    ...
                    <ul class="request-list">
                        <?php getUrgentRequests($sess_id); ?>
                    </ul>
                    <button class="btn btn-outline" style="margin-top: 0.8rem; width: 100%;" data-page="requests">
                        View All Requests
                    </button>
                </section>
            </div>
            ...
            <div class="dashboard">
                <section class="card" style="grid-column: 1 / -1;">
                    ...
                    <ul class="request-list" id="requestsList">
                        <?php
                        // display requests for donor
                        getDonorRequessts($sess_id);
                        ?>
                    </ul>
                </section>
            </div>
                ...
                <section class="card">
                    ...
                    <form id="profileForm" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" class="form-control" name="email" value="<?php echo $current_session?>" required>
                        </div>
                        <div class="form-group">
