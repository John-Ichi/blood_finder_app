...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/bloodbank-login.css">
...
<body>
    ...
    <img class="wave" src="resources/wave.svg">
    <div class="container">
        <div class="img">
        ...
        <div class="login-content" id="login-form-section">
            <form method="POST">
                <img src="resources/surgeon-doctor.svg">
                ...
                <div style="margin-top:10px;text-align:center;">
                    <a href="bloodbank-signup.php">Sign Up</a>
                </div>
            </form>
        </div>
