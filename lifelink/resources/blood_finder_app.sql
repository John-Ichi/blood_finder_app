...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2025 at 11:14 AM
...
(45, 17, ' DUMMY', 'johnichiro.mananquil.photos2@gmail.com', '09xxxxxxxxx', 'Need RBC', 0, NULL, 'Naic Doctors Hospital', '2025-06-21', 'Done'),
(48, 16, 'TEST REFACTORED', 'johnichiro.mananquil.photos2@gmail.com', '09xxxxxxxxx', 'Road accident', 1, NULL, 'Naic Doctors Hospital', '2025-06-14', 'Pending'),
(49, 16, ' TEST REFACTORED', 'johnichiro.mananquil.photos2@gmail.com', '09xxxxxxxxx', 'Road accident', 1, NULL, 'Naic Doctors Hospital', '2025-06-14', 'Pending');
...
(49, 15, '2025-06-18', 'Morning (8AM - 12PM)', 4, 'No additional information regarding donor.', 'Approved');
...
(49, NULL, 47, 14, 4, '2025-06-18 15:50:29', 'Whole Blood', 1, 0),
(50, 45, NULL, 17, NULL, '2025-06-21 00:00:00', NULL, NULL, 0);
...
(16, 'Ichoooi', 'AB+', 'Trece Martires City, Cavite', '09xxxxxxxxx', 'Test', 1, '2025-06-13'),
(17, 'TESTING', 'O-', 'Naic, Cavite', '09xxxxxxxxx', 'TEST UPDATE', 0, '2025-08-03'),
(15, 'Ceejay Cervantes', 'B-', 'Kawit, Cavite', '09xxxxxxxxx', '', 1, '2025-06-13');
...
(14, 'yukinoo0713@gmail.com', '$2y$10$rn0OpJtiQHJMSvAyOOVm1eTkopBERWa4WM5dMIybWFz6hNVbCn4sW', '2025-06-13', 1, '2025-06-03'),
(15, 'johnichiro.mananquil.photos@gmail.com', '$2y$10$..ct3k.KyKwObTC/LWsLWuujTOH/bxQ5XXapvKig0xlAqr8gVtgUW', '2025-06-11', 1, '2025-06-06'),
(16, 'ichiljay@gmail.com', '$2y$10$9qY6KT3K1D.MKVfoiEJg6OmMOZ2.it43Da2rNzzNXouj5DEzdgF6G', '2025-06-13', 1, '2025-06-06'),
(17, 'ajbernaio505@gmail.com', '$2y$10$nziyGASijgBBOOjNk6kdauEu10bePKLJX1O6i0xjHuE2A169kMEye', '2025-06-13', 1, '2025-06-11');
...
(5, 'Test Hospital Info', 'Dasmarinas City, Cavite', '34-5678-9012');
...
(5, 'dominiqueaira13@gmail.com', '$2y$10$ZeIUaRnrjP72NDywCkTRZO5rTfmpHI9WZTE8da9yZ7gKAh24ro1AK', NULL, 1, '2025-06-11'),
(6, 'ramonmananquil03@gmail.com', '$2y$10$oLu2erQl7rHLsrSzc5EyWuA63/6JlaoaHAQ2EjHPQRea.5FfAf6Oa', NULL, 1, '2025-06-13');
...
--
ALTER TABLE `donation_appointments`
  MODIFY `donation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
