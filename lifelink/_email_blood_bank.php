...
<head>
    ...
    <title>Contact Blood Bank - Blood Donation System</title>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    <link rel="stylesheet" href="_email_blood_bank.css">
</head>
<body>
    <div class="container">
        <div class="header">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="_functions.php">
                <input style="none" type="hidden" name="blood_bank_email" value="<?php echo $hospital_email?>" readonly>
