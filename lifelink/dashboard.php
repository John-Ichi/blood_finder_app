...
if($check_sess_info->num_rows === 0) {
    header('Location: user-info.php'); // complete details
}
...
if (isset($_POST['update'])) {
    ...
    $new_note = $_POST['donor_notes'];
    $sql = "UPDATE `donor_info`
    SET `name`='$new_name',
    `email`='$new_email',
    `contact`='$new_contact',
    `address`='$new_address',
    `donor_notes`='$new_note'
                    ...
                    <div style="text-align: center; padding: 1.5rem 0;">
                        ...
                        <p>
                            ...
                            if($last_donation != "No Record") {
                                ...
                                echo $last_donation;
                            /* if ($last_donation != "No Record") {
                                echo $last_donation . " at Philippine Red Cross - Manila";
                            }
                            else {
                                echo $last_donation;
                            } */
            ...
            <!-- Personal Information Card -->    
                <section class="card">
                    ...
                    <form id="profileForm" method="POST">
                        ...
                        <!-- <input type="hidden" name="bloodTypeProfile" value="O+"> --> 
                        </div>
